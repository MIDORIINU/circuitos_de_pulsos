...
\newcommand{\titulolargo}{Diseño e implementación de un circuito digital discreto \\ Repetidor de controles remotos infrarrojos}
\newcommand{\materia}{Circuitos de pulsos - 66.19}
...
\newcommand{\docenteA}{Ing. \textsc{Fuchs} Jorge H.}
\newcommand{\docenteB}{Ing. \textsc{Hentschel} Ricardo Gabriel}



\newcommand{\thedate}{27 de julio de 2019}
...
\definecolor{TABLEColor}{RGB}{70,19,199}
...
\fancyhf[LH]{\includegraphics[width=3cm]{./img/logo_encabezado_fiuba}}
\fancyhf[CH]{\small{\materia}}
\fancyhf[RH]{\titulo}
